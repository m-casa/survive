        ...
        public struct ExchangeRecipe
        {
            ...
            public struct Material
            {
                ...
                public bool Valid
                {
                    get
                    {
                        if (item.item == null && (string.IsNullOrEmpty(tag.name) || string.IsNullOrEmpty(tag.value)))
                            return false;
                        if ((string.IsNullOrEmpty(tag.name) && string.IsNullOrEmpty(tag.value)) && tag.count == 0)
                            return false;
                        if (item.item != null && item.item.item_type != Enums.InventoryItemType.item)
                            return false;
        ...
        public class Price
        {
            ...
            public class PriceList
            {
                ...
                public override string ToString()
                {
                    ...
                    StringBuilder sb = new StringBuilder();
                    sb.Append(version.ToString() + ";" + original.ToString());
            ...
            public void Populate(SteamItemDef_t itemDefId)
            {
                ...
                else
                {
                    ...
                    if (!string.IsNullOrEmpty(result))
                    {
                        ...
                        priceList.version = uint.Parse(entries[0]);
