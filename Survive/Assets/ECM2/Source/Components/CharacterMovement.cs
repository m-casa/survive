...
namespace EasyCharacterMovement
{
    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        public new Collider collider => _capsuleCollider;
        ...
        /// <param name="acceleration">Maximum acceleration (rate of change of velocity).</param>
        ...
        /// <param name="brakingFriction">Friction (drag) coefficient applied when braking (whenever Acceleration = 0, or if character is exceeding max speed).</param>
        ...
        /// <summary>
        /// Cache and initialize character's Rigidbody (eg: make sure it is kinematic).
        /// </summary>
        ...
        private void InitRigidbody()
        {
            ...
            {
                Debug.LogError("CharacterMovement: Could not find Rigidbody component!");
            }
        }

        /// <summary>
        /// Cache an initialize character's collider.
        /// </summary>
        ...
        private void InitCollider()
        {
            if (TryGetComponent(out CapsuleCollider capsuleCollider))
                ...
                Debug.LogError("CharacterMovement: Could not find CapsuleCollider component!");
        }
        ...
        private Vector3 ComputeCollisionResponse(Vector3 displacement, Vector3 inNormal, bool isWalkable)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    displacement = _isConstrainedToGround
                        ? HandleSlopeBoosting(slideResult, displacement, inNormal)
                        : slideResult;
                }
            }
        ...
        private void Reset()
        {
            ...
            _planeConstraint = PlaneConstraint.None;
            _constraintPlaneNormal = Vector3.zero;
        ...
        private void OnValidate()
        {
            ...
            SetPlaneConstraint(_planeConstraint, Vector3.zero);
